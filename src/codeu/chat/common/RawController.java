...
public interface RawController {
  ...
  Message newMessage(String id, String author, String conversation, String body, Time creationTime);

  // NEW USER
  //
  // Add a new user to the model with a specific id. If the id is already in
  // use, the call will fail and null will be returned.
  User newUser(String id, String name, Time creationTime);
  ...
  Conversation newConversation(String id, String title, String owner, Time creationTime);
